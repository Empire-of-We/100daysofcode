...
if step_1 == "sun":
    ...
    if step_2 == "coconuts":
        ...
        if step_3 == "leaves":
            ...
            step_4 = input("It is a new day. You see something reflect off a seagulls. You are both hungry and curious.  You don't see anymore coconuts but think you see some crabs in the water.  Do you pick up a rock and kill the seagull or try to gather the crustateans? Type 'rock' or 'gather'\n").lower()
            if step_4 == "rock":
                ...
                print("You fall asleep inbetween the boulders.  You didn't realize the tide was low and drown.  GAME OVER.")
    else: 
